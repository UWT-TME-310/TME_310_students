...
1. **Diesel hammer combustion**
   ...
   **A mathematical framework for the combustion model will be provided to you.**
...
2. **Pile Driving Analysis (PDA) from instrumentation**
   ...
   **A mathematical framework for PDA analysis will be provided to you.**
...
1. **Environmental noise assessment**
   ...
   **A mathematical framework for the sound volume model will be provided to you.**
...
An external source will be provided for the *Diesiel hammer combusion* and *Environmental noise assessment* options.
For the *PDA instrumentation* option, the "external" source will be the final capacity estimated from the pile-driving log.
...
- The PDA force and velocity (both on the y-axis) vs time (x-axis). Include markers on the plot that indicate the peaks of the downward traveling and upward traveling waves.
